...
angular.module('ngForce', [], function ($provide) {
    $provide.factory('vfr', function () {
        ...
        vfRemote.publishResponse = function (fields, callback, error) {
            var deferred = $.Deferred();
            Visualforce.remoting.Manager.invokeAction('ngForceController.publishResponse', fields, function (result) {
                handleResult(result, callback, error, false, deferred);
            }, {
                escape: false
            });
        ...
        vfRemote.bulkUpdate = function (objtype, fields, callback, error) {
            var deferred = $.Deferred();
            Visualforce.remoting.Manager.invokeAction('ngForceController.bulkUpdate', objtype, fields,
                function (result) {
                    handleResult(result, callback, error, true, deferred);
                }, {
                    escape: false
