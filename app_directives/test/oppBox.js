 ...
 * invoked.
 */
app.directive('oppBox', function(ngForceConfig){ 
	return {
		...
		templateUrl: ngForceConfig.resourceUrl+'/app_templates/test/oppBox.html', // or specify a file to use as the template for the directive
